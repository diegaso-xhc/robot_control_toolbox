classdef ControlSerialMultiDOF
    ...
    methods
        ...
        function run_cartesian_torque_controller(obj, ths, dt)
            ...
            for j = 1: length(obj.goal_poses.cartesian_poses)
                ...
                while(true)
                    ...
                    % dJb = get_andiff_J(obj, Js, p.current, dthetalist); % Analytical jacobian differentiation (tailored for double pendulum)
        ...
        function dJb = get_andiff_J(obj, Js, Tsb, dthetalist)
            ...
            dJs_an = [0, 0, 0, -obj.syst.l2*c12 - Jv2(2), -obj.syst.l2*s12 + Jv2(1), 0;
                0, 0, 0, 0, 0, 0;]';                    
